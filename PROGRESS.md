...
- [x] GALLUS² — `4227_gallus` — [package](pets/gallus2)
...
- [x] 冬时 / Снегурочка — `4208_wintim` — [package](pets/snegurochka)
- [x] 刻刀 / Cutter — `301_cutter` — [package](pets/cutter)
- [x] 协律 / Akkord — `4051_akkord` — [package](pets/akkord)
...
- [x] 三角初华 / Misumi Uika — `4184_dolris` — [package](pets/misumi-uika)
- [x] 临光 / Nearl — `148_nearl` — [package](pets/nearl)
- [x] 乌啾 / Укусик — `4224_turdus` — [package](pets/ukusik)
...
- [x] 哈蒂娅 / Hadiya — `394_hadiya` — [package](pets/hadiya)
- [x] 响石 / Cairn — `4214_cairn` — [package](pets/cairn)
...
- [x] 复奏 / Ripresa — `4031_liesel` — [package](pets/ripresa)
...
- [x] 天空盒 / Skybox — `4213_skybx` — [package](pets/skybox)
...
- [x] 摆渡人 / Varkáris — `4166_varkis` — [package](pets/varkaris)
- [x] 摩根 / Morgan — `154_morgan` — [package](pets/morgan)
- [x] 撷英调香师 / Perfumer the Distilled — 异格 / alternate — `1022_flwr2` — [package](pets/perfumer-the-distilled)
...
- [x] 矩 / Ju — `4221_ju` — [package](pets/ju)
...
- [x] 若叶睦 / Wakaba Mutsumi — `4183_mortis` — [package](pets/wakaba-mutsumi)
...
- [x] 裂响 / Crackborne — `4225_tanya` — [package](pets/crackborne)
...
- [x] 风絮 / Taraxacum — `4222_taraxa` — [package](pets/taraxacum)
...
- [x] 丰川祥子 / Togawa Sakiko — `4182_oblvns` — [package](pets/togawa-sakiko)
...
- [x] 娜斯提 / Nasti — `4212_nasti` — [package](pets/nasti)
